...
def add_employee():
    ...
    if request.method == 'POST':
        if  len(request.form['nome']) != 0 and len(request.form['sobre_nome']) != 0 and len(request.form['sexo']) != 0:
            if request.form.get("funcionario"):
                ...
                try:
                    ...
                    flash("Insira valores numéricos no campo salário.")
